...
class DSPConfig:
    ...
    anf_depth:       float = 0.5   # profundidad de atenuación del tono detectado (0=nada, 1=máximo; se puede subir: la detección por persistencia ya no toma la voz por tono)
