...
# El freno es ajustable desde la UI, asi que el estado vivo es `_fall_db_s` y hay
# que moverlo con su setter: pisar la constante de clase `_MCRA_FALL_DB_S` despues
