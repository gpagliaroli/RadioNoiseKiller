...
Cada etapa tiene **su propio indicador**, arriba de su slider: **Actividad de trama** y **Actividad micro**, en disparos por segundo (⚡ N /s). Van separados porque cuentan cosas de distinta escala —la etapa micro dispara por cada mini-trama de 0,67 ms y la de trama una vez por bloque— así que sumados el número lo domina la micro: con los valores por defecto, la de trama aportaba menos del 10 %, y mover su umbral casi no movía la aguja. Con dos indicadores se ve cuál de las dos está trabajando, que es lo que hace falta para ajustarlas por separado.
