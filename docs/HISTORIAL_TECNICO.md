# RadioNoiseKiller — Historial técnico

Registro completo de lo que se hizo, se midió y se descartó en cada versión, **tal como se fue
escribiendo en `CLAUDE.md`** hasta que ese archivo superó el límite de 150k caracteres que
Claude Code carga por sesión (septiembre 2026). Se movió acá **sin resumir ni recortar**: cada
bloque conserva sus mediciones, las citas del usuario y el porqué de cada decisión.

**Cómo usarlo:** no se carga entero. `CLAUDE.md` tiene la lista corta de "descartado — no
reproponer" y las reglas de método; cuando haga falta el detalle de un hilo, buscar acá por
versión (`v2.2 —`, `Post-v2.3`) o por palabra clave (`λ_d`, `oráculo`, `a igual voz`, `UPX`).

**Dónde van las notas nuevas:** los bloques narrativos de una versión en curso se escriben acá,
al principio de la sección "En curso" de abajo. En `CLAUDE.md` va sólo la línea de resumen en
"Cambios pendientes de release" y, si aplica, la entrada en "Descartado — no reproponer" o una
regla de método nueva.

## Índice de versiones

| Versión | Fecha | Salto | Resumen |
|---|---|---|---|
| v1.2 | jul 2026 | menor | MCRA, Log-MMSE, post-filtro, squelch, piso perceptual, pitch SSB, fading HF |
| v1.3 | jul 2026 | menor | Renombre a RadioNoiseKiller, fix squelch+AGC, cuarentena MCRA, limitador soft-knee |
| v1.4 | jul 2026 | menor | CPU para AMD A6, libasound fuera del bundle, presets de fábrica, nivelador de voz, S/N |
| v1.5 | jul 2026 | menor | Recorte Qt, botón ⟳, i18n ES/EN, ícono, decoraciones Wayland |
| v1.6 | jul 2026 | menor | Canal de entrada, pasabanda de salida independiente, módulos DSP no escriben en config |
| v1.7 | jul 2026 | menor | Grabación WAV, perfiles de ruido nombrados, presets Voz natural, test_ui |
| v1.8 / .1 / .2 | jul 2026 | menor+patch | Cascada, AGC Custom eliminado, snapshot() de presets, aviso −9993, Mute, nivelador continuo |
| v1.9 / .1 | jul 2026 | menor+patch | Reactividad del piso, refuerzo en agudos, fading VAD-smart, anti-gorgojeo, Post-Filtro en Principal |
| v2.0 | ago 2026 | **mayor** | Post-filtro en dB, excitador reescrito, freeze MCRA por periodicidad, ataque de sílaba, graves |
| v2.1 | ago 2026 | menor | Cascada completa, techo de ruido del AGC, seed de presets, ARM64 experimental, tooltips, escala UI |
| v2.2 | ago 2026 | menor | ANF con persistencia, supresor por contraste local, fading comp eliminada, cascada Diferencia, Cafecito |
| v2.3 | ago 2026 | menor | Gate de ruido reemplaza al squelch, combo Pasabanda reemplaza a Modo, Freno de bajada, Congelar piso con voz |
| v2.4 | ago 2026 | menor | Umbral de trama 2–30, indicador por etapa del supresor, sliders λ_d grises en estático, presets 7 → 5 |
| v2.4.1 | sep 2026 | patch | Exclusión de armónicos sostenidos del piso (constante), 5 presets reafinados, git mv por mayúsculas |

---

## En curso (post-v2.4.1)

_(Los bloques nuevos de la próxima versión van acá, el más reciente arriba.)_

---

## v1.2 → v1.4 (julio 2026)
...
- Revisión de bugs pre-release: clamp de pf_boost desalineado con el slider, squelch podía mutear
  ...
  fading aplicando en modo static (ver "Invariantes a mantener" en `CLAUDE.md`)
...
## v2.1 → v2.4.1 (agosto–septiembre 2026)

> Estos bloques están **en el orden en que se escribieron en `CLAUDE.md`** (en general, el más
> reciente arriba), no estrictamente por versión: un hilo abierto en la v2.2 puede tener su cierre
> en un bloque "Post-v2.4". Buscar por el prefijo del título (`v2.2 —`, `Post-v2.3`, `Post-v2.4`).

### Compensación de fading HF (noise_fading_comp) — cómo funcionaba antes de eliminarla
